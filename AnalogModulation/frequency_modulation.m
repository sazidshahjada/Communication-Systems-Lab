...
% Generating Frequency Modulated Signal

modulation_index = 10;

modulated_signal = carrier_amplitude .* cos(2 * pi * carrier_frequency * time + modulation_index .* sin(2 * pi * message_frequency * time))
